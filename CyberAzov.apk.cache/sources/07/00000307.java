...
class Poly1305 {
    ...
    public static byte[] computeMac(final byte[] key, byte[] data) {
        ...
        long load32 = ((j32 | (j26 & j37) | (j38 << 26)) & 4294967295L) + load32(key, 16);
        long j41 = load32 & 4294967295L;
        long load322 = (((j38 >> 6) | (j39 << 20)) & 4294967295L) + load32(key, 20) + (load32 >> 32);
        long load323 = (((j39 >> 12) | (j40 << 14)) & 4294967295L) + load32(key, 24) + (load322 >> 32);
        byte[] bArr2 = new byte[16];
        toByteArray(bArr2, j41, 0);
        toByteArray(bArr2, load322 & 4294967295L, 4);
        toByteArray(bArr2, load323 & 4294967295L, 8);
        toByteArray(bArr2, ((((j40 >> 18) | (((j30 & j37) | j36) << 8)) & 4294967295L) + load32(key, 28) + (load323 >> 32)) & 4294967295L, 12);
        return bArr2;
    }
