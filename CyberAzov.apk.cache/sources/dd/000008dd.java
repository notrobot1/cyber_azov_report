...
class URangesKt___URangesKt {
    ...
    private static final boolean m1280containsbiwQdVI(UIntRange contains, UInt uInt) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return uInt != null && contains.m1252containsWZ4Q5Ns(uInt.m193unboximpl());
    }

    /* renamed from: contains-GYNo2lE  reason: not valid java name */
    private static final boolean m1276containsGYNo2lE(ULongRange contains, ULong uLong) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return uLong != null && contains.m1258containsVKZWuLQ(uLong.m271unboximpl());
    }

    /* renamed from: contains-68kG9v0  reason: not valid java name */
    public static final boolean m1275contains68kG9v0(UIntRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1252containsWZ4Q5Ns(UInt.m142constructorimpl(b & UByte.MAX_VALUE));
    }

    /* renamed from: contains-ULb-yJY  reason: not valid java name */
    public static final boolean m1278containsULbyJY(ULongRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1258containsVKZWuLQ(ULong.m220constructorimpl(b & 255));
    }

    /* renamed from: contains-Gab390E  reason: not valid java name */
    public static final boolean m1277containsGab390E(ULongRange contains, int i) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1258containsVKZWuLQ(ULong.m220constructorimpl(i & 4294967295L));
    }

    /* renamed from: contains-fz5IDCE  reason: not valid java name */
    public static final boolean m1281containsfz5IDCE(UIntRange contains, long j) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return ULong.m220constructorimpl(j >>> 32) == 0 && contains.m1252containsWZ4Q5Ns(UInt.m142constructorimpl((int) j));
    }

    /* renamed from: contains-ZsK3CEQ  reason: not valid java name */
    public static final boolean m1279containsZsK3CEQ(UIntRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1252containsWZ4Q5Ns(UInt.m142constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: contains-uhHAxoY  reason: not valid java name */
    public static final boolean m1282containsuhHAxoY(ULongRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1258containsVKZWuLQ(ULong.m220constructorimpl(s & 65535));
    }

    /* renamed from: downTo-Kr8caGY  reason: not valid java name */
    public static final UIntProgression m1285downToKr8caGY(byte b, byte b2) {
        return UIntProgression.Companion.m1251fromClosedRangeNkh28Cs(UInt.m142constructorimpl(b & UByte.MAX_VALUE), UInt.m142constructorimpl(b2 & UByte.MAX_VALUE), -1);
    }
    ...
    public static final ULongProgression m1286downToeb3DHEI(long j, long j2) {
        return ULongProgression.Companion.m1257fromClosedRange7ftBX0g(j, j2, -1L);
    }

    /* renamed from: downTo-5PvTz6A  reason: not valid java name */
    public static final UIntProgression m1283downTo5PvTz6A(short s, short s2) {
        return UIntProgression.Companion.m1251fromClosedRangeNkh28Cs(UInt.m142constructorimpl(s & UShort.MAX_VALUE), UInt.m142constructorimpl(s2 & UShort.MAX_VALUE), -1);
    }
    ...
    public static final UIntProgression step(UIntProgression uIntProgression, int i) {
        ...
        int m1249getFirstpVg5ArA = uIntProgression.m1249getFirstpVg5ArA();
        int m1250getLastpVg5ArA = uIntProgression.m1250getLastpVg5ArA();
        if (uIntProgression.getStep() <= 0) {
            i = -i;
        }
        return companion.m1251fromClosedRangeNkh28Cs(m1249getFirstpVg5ArA, m1250getLastpVg5ArA, i);
    }
    ...
    public static final ULongProgression step(ULongProgression uLongProgression, long j) {
        ...
        long m1255getFirstsVKNKU = uLongProgression.m1255getFirstsVKNKU();
        long m1256getLastsVKNKU = uLongProgression.m1256getLastsVKNKU();
        if (uLongProgression.getStep() <= 0) {
            j = -j;
        }
        return companion.m1257fromClosedRange7ftBX0g(m1255getFirstsVKNKU, m1256getLastsVKNKU, j);
    }

    /* renamed from: until-Kr8caGY  reason: not valid java name */
    public static final UIntRange m1289untilKr8caGY(byte b, byte b2) {
        int i = b2 & UByte.MAX_VALUE;
        return Intrinsics.compare(i, 0) <= 0 ? UIntRange.Companion.getEMPTY() : new UIntRange(UInt.m142constructorimpl(b & UByte.MAX_VALUE), UInt.m142constructorimpl(UInt.m142constructorimpl(i) - 1), null);
    }

    /* renamed from: until-J1ME1BU  reason: not valid java name */
    public static final UIntRange m1288untilJ1ME1BU(int i, int i2) {
        return UnsignedKt.uintCompare(i2, 0) <= 0 ? UIntRange.Companion.getEMPTY() : new UIntRange(i, UInt.m142constructorimpl(i2 - 1), null);
    }

    /* renamed from: until-eb3DHEI  reason: not valid java name */
    public static final ULongRange m1290untileb3DHEI(long j, long j2) {
        return UnsignedKt.ulongCompare(j2, 0L) <= 0 ? ULongRange.Companion.getEMPTY() : new ULongRange(j, ULong.m220constructorimpl(j2 - ULong.m220constructorimpl(1 & 4294967295L)), null);
    }

    /* renamed from: until-5PvTz6A  reason: not valid java name */
    public static final UIntRange m1287until5PvTz6A(short s, short s2) {
        int i = s2 & UShort.MAX_VALUE;
        return Intrinsics.compare(i, 0) <= 0 ? UIntRange.Companion.getEMPTY() : new UIntRange(UInt.m142constructorimpl(s & UShort.MAX_VALUE), UInt.m142constructorimpl(UInt.m142constructorimpl(i) - 1), null);
    }
    ...
    public static final int m1271coerceInWZ9TVnA(int i, int i2, int i3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UInt.m187toStringimpl(i3)) + " is less than minimum " + ((Object) UInt.m187toStringimpl(i2)) + '.');
    }
    ...
    public static final long m1273coerceInsambcqE(long j, long j2, long j3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) ULong.m265toStringimpl(j3)) + " is less than minimum " + ((Object) ULong.m265toStringimpl(j2)) + '.');
    }
    ...
    public static final byte m1272coerceInb33U2AM(byte b, byte b2, byte b3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UByte.m109toStringimpl(b3)) + " is less than minimum " + ((Object) UByte.m109toStringimpl(b2)) + '.');
    }
    ...
    public static final short m1270coerceInVKSA0NQ(short s, short s2, short s3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UShort.m369toStringimpl(s3)) + " is less than minimum " + ((Object) UShort.m369toStringimpl(s2)) + '.');
    }

    /* renamed from: coerceIn-wuiCnnA  reason: not valid java name */
    public static final int m1274coerceInwuiCnnA(int i, ClosedRange<UInt> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m136boximpl(i), (ClosedFloatingPointRange<UInt>) range)).m193unboximpl();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        }
        return UnsignedKt.uintCompare(i, range.getStart().m193unboximpl()) < 0 ? range.getStart().m193unboximpl() : UnsignedKt.uintCompare(i, range.getEndInclusive().m193unboximpl()) > 0 ? range.getEndInclusive().m193unboximpl() : i;
    }

    /* renamed from: coerceIn-JPwROB0  reason: not valid java name */
    public static final long m1269coerceInJPwROB0(long j, ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m214boximpl(j), (ClosedFloatingPointRange<ULong>) range)).m271unboximpl();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        }
        return UnsignedKt.ulongCompare(j, range.getStart().m271unboximpl()) < 0 ? range.getStart().m271unboximpl() : UnsignedKt.ulongCompare(j, range.getEndInclusive().m271unboximpl()) > 0 ? range.getEndInclusive().m271unboximpl() : j;
    }
}