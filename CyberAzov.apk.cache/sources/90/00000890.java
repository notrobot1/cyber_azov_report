...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static final /* synthetic */ UByteArray m116boximpl(byte[] bArr) {
        return new UByteArray(bArr);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static byte[] m118constructorimpl(byte[] storage) {
    ...
    public static boolean m121equalsimpl(byte[] bArr, Object obj) {
        return (obj instanceof UByteArray) && Intrinsics.areEqual(bArr, ((UByteArray) obj).m132unboximpl());
    }
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m120containsAllimpl(this.storage, elements);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m120containsAllimpl(byte[] bArr, Collection<UByte> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<UByte> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if (!(obj instanceof UByte) || !ArraysKt.contains(bArr, ((UByte) obj).m115unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
