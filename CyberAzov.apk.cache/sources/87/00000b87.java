...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        float f9 = widgetFrame3.visibility == 4 ? 0.0f : f3;
        ...
        widgetFrame.top = i21;
        float f10 = 1.0f - f;
        widgetFrame.right = i20 + ((int) ((i4 * f10) + (i18 * f)));
        widgetFrame.bottom = i21 + ((int) ((f10 * i3) + (i19 * f)));
        ...
        widgetFrame.alpha = interpolate(f4, f9, 1.0f, f);
