...
public final class WithLifecycleStateKt {
    ...
    public static final <R> Object suspendWithStateAtLeastUnchecked(final Lifecycle lifecycle, final Lifecycle.State state, boolean z, CoroutineDispatcher coroutineDispatcher, final Function0<? extends R> function0, Continuation<? super R> continuation) {
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        obj = Result.m48constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                    ...
                    cancellableContinuationImpl2.resumeWith(Result.m48constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (z) {
        ...
        cancellableContinuationImpl2.invokeOnCancellation(new WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2(coroutineDispatcher, lifecycle, r2));
