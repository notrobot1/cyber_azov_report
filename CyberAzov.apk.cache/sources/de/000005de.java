...
public interface SendChannel<E> {
    ...
    Object mo1472trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1472trySendJP2dKIU = sendChannel.mo1472trySendJP2dKIU(e);
            if (ChannelResult.m1487isSuccessimpl(mo1472trySendJP2dKIU)) {
                return true;
            }
            Throwable m1481exceptionOrNullimpl = ChannelResult.m1481exceptionOrNullimpl(mo1472trySendJP2dKIU);
