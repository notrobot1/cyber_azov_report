...
public class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
        ...
        try {
            ...
            if (i2 > 0) {
                ...
                if (read2 != -1) {
                    ...
                    ByteStreamsKt.copyTo$default(fileInputStream2, exposingBufferByteArrayOutputStream, 0, 2, th);
    ...
    public static final void writeBytes(File file, byte[] array) {
        ...
        try {
            new FileOutputStream(file).write(array);
    ...
    public static final void appendBytes(File file, byte[] array) {
        ...
        Intrinsics.checkNotNullParameter(array, "array");
        try {
            new FileOutputStream(file, true).write(array);
            Unit unit = Unit.INSTANCE;
            th = null;
        } finally {
        }
    ...
    public static final String readText(File file, Charset charset) {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        try {
            String readText = TextStreamsKt.readText(new InputStreamReader(new FileInputStream(file), charset));
            th = null;
            return readText;
        } finally {
        }
    ...
    public static /* synthetic */ Object useLines$default(File file, Charset charset, Function1 function1, int i, Object obj) {
        ...
        th = null;
        try {
            return function1.invoke(TextStreamsKt.lineSequence(inputStreamReader instanceof BufferedReader ? (BufferedReader) inputStreamReader : new BufferedReader(inputStreamReader, 8192)));
        } finally {
        }
    }
    ...
    public static final <T> T useLines(File file, Charset charset, Function1<? super Sequence<String>, ? extends T> block) {
        ...
        th = null;
        try {
            return block.invoke(TextStreamsKt.lineSequence(inputStreamReader instanceof BufferedReader ? (BufferedReader) inputStreamReader : new BufferedReader(inputStreamReader, 8192)));
        } finally {
        }
    }
}