...
class UArraysKt___UArraysJvmKt {
    ...
    private static final int m521elementAtqFRl0hI(int[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UIntArray.m201getpVg5ArA(elementAt, i);
    }

    /* renamed from: elementAt-r7IrZao  reason: not valid java name */
    private static final long m522elementAtr7IrZao(long[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return ULongArray.m279getsVKNKU(elementAt, i);
    }

    /* renamed from: elementAt-PpDY95g  reason: not valid java name */
    private static final byte m519elementAtPpDY95g(byte[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UByteArray.m123getw2LRezQ(elementAt, i);
    }

    /* renamed from: elementAt-nggk6HY  reason: not valid java name */
    private static final short m520elementAtnggk6HY(short[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UShortArray.m383getMh2AYeg(elementAt, i);
    }
    ...
    public static final int m511binarySearch2fe2U9s(int[] binarySearch, int i, int i2, int i3) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i2, i3, UIntArray.m202getSizeimpl(binarySearch));
        int i4 = i3 - 1;
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
    ...
    public static final int m515binarySearchK6DWlUc(long[] binarySearch, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, ULongArray.m280getSizeimpl(binarySearch));
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static final int m517binarySearchWpHrYlw(byte[] binarySearch, byte b, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, UByteArray.m124getSizeimpl(binarySearch));
    ...
    public static final int m513binarySearchEtDCXyQ(short[] binarySearch, short s, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, UShortArray.m384getSizeimpl(binarySearch));
    ...
    private static final BigDecimal sumOfBigDecimal(int[] sumOf, Function1<? super UInt, ? extends BigDecimal> selector) {
        ...
        int m202getSizeimpl = UIntArray.m202getSizeimpl(sumOf);
        for (int i = 0; i < m202getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UInt.m136boximpl(UIntArray.m201getpVg5ArA(sumOf, i))));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] sumOf, Function1<? super ULong, ? extends BigDecimal> selector) {
        ...
        for (int i = 0; i < m280getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(ULong.m214boximpl(ULongArray.m279getsVKNKU(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] sumOf, Function1<? super UByte, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m124getSizeimpl = UByteArray.m124getSizeimpl(sumOf);
        for (int i = 0; i < m124getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UByte.m60boximpl(UByteArray.m123getw2LRezQ(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sumOf, Function1<? super UShort, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m384getSizeimpl = UShortArray.m384getSizeimpl(sumOf);
        for (int i = 0; i < m384getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UShort.m320boximpl(UShortArray.m383getMh2AYeg(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
