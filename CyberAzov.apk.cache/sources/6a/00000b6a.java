    ...
    public class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str3 = "_";
                StringBuilder append = new StringBuilder().append((("" + (constraintWidget.mTop.mTarget != null ? "T" : str3)) + (constraintWidget.mBottom.mTarget != null ? "B" : str3)) + (constraintWidget.mLeft.mTarget != null ? "L" : str3));
                ...
                Log.v(MotionLayout.TAG, str2 + "  " + name + " " + constraintWidget + " " + sb);
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mMeasureDuringTransition || z) {
            ...
            if (i3 == Integer.MIN_VALUE || i3 == 0) {
                width = (int) (this.mStartWrapWidth + (this.mPostInterpolationPosition * (this.mEndWrapWidth - i2)));
                requestLayout();
            }
            int i4 = this.mHeightMeasureMode;
            if (i4 == Integer.MIN_VALUE || i4 == 0) {
                height = (int) (this.mStartWrapHeight + (this.mPostInterpolationPosition * (this.mEndWrapHeight - i)));
                requestLayout();
            }
    ...
    private class DevModeDraw {
        ...
        private void drawTicks(Canvas canvas, int mode, int keyFrames, MotionController motionController) {
            ...
            if (motionController.mView != null) {
                i2 = motionController.mView.getWidth();
                i = motionController.mView.getHeight();
            } else {
                i2 = 0;
                i = 0;
            }
                ...
                if (mode != 4 || this.mPathMode[i3 - 1] != 0) {
                    ...
                    if (mode == 4) {
                        ...
                        if (iArr[i5] == 1) {
                            ...
                            f2 = f4;
                            f = f3;
                            drawPathScreenTicks(canvas, f3 - 0.0f, f4 - 0.0f, i2, i);
    ...
    */
    ...
    public void getAnchorDpDt(int mTouchAnchorId, float pos, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        if (viewById == null) {
            ...
            str = viewById.getContext().getResources().getResourceName(mTouchAnchorId);
        }
