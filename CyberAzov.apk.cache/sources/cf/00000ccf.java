...
public final class FragmentContainerView extends FrameLayout {
    ...
    public WindowInsets dispatchApplyWindowInsets(WindowInsets insets) {
        ...
        Intrinsics.checkNotNullParameter(insets, "insets");
        WindowInsetsCompat windowInsetsCompat2 = WindowInsetsCompat.toWindowInsetsCompat(insets);
        ...
        if (this.applyWindowInsetsListener != null) {
            ...
            windowInsetsCompat = WindowInsetsCompat.toWindowInsetsCompat(api20Impl.onApplyWindowInsets(onApplyWindowInsetsListener, this, insets));
        } else {
