...
public final /* synthetic */ class FlowKt__ChannelsKt {
    ...
    /* JADX WARN: Removed duplicated region for block: B:28:0x0077 A[Catch: all -> 0x0056, TRY_LEAVE, TryCatch #0 {all -> 0x0056, blocks: (B:13:0x0033, B:18:0x004c, B:26:0x0071, B:28:0x0077, B:34:0x0085, B:35:0x0086), top: B:45:0x0023 }] */
    /* JADX WARN: Removed duplicated region for block: B:35:0x0086 A[Catch: all -> 0x0056, TRY_LEAVE, TryCatch #0 {all -> 0x0056, blocks: (B:13:0x0033, B:18:0x004c, B:26:0x0071, B:28:0x0077, B:34:0x0085, B:35:0x0086), top: B:45:0x0023 }] */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:36:0x0096 -> B:14:0x0036). Please submit an issue!!! */
    /*
    ...
    */
    public static final <T> java.lang.Object emitAllImpl$FlowKt__ChannelsKt(kotlinx.coroutines.flow.FlowCollector<? super T> r7, kotlinx.coroutines.channels.ReceiveChannel<? extends T> r8, boolean r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        ...
        L42:
            ...
            java.lang.Object r10 = r10.m1489unboximpl()     // Catch: java.lang.Throwable -> L56
            goto L70
        L56:
            r9 = move-exception
            goto L9d
        ...
        L5e:
            ...
            java.lang.Object r10 = r8.mo1470receiveCatchingJP2dKIU(r0)     // Catch: java.lang.Throwable -> L99
            if (r10 != r1) goto L6d
            return r1
        L6d:
            r6 = r9
        ...
        L70:
            r2 = 0
            boolean r5 = kotlinx.coroutines.channels.ChannelResult.m1485isClosedimpl(r10)     // Catch: java.lang.Throwable -> L56
            if (r5 == 0) goto L86
            java.lang.Throwable r9 = kotlinx.coroutines.channels.ChannelResult.m1481exceptionOrNullimpl(r10)     // Catch: java.lang.Throwable -> L56
            if (r9 != 0) goto L85
            if (r7 == 0) goto L82
        ...
        L86:
            java.lang.Object r10 = kotlinx.coroutines.channels.ChannelResult.m1483getOrThrowimpl(r10)     // Catch: java.lang.Throwable -> L56
    ...
    public static final <T> BroadcastChannel<T> broadcastIn(Flow<? extends T> flow, CoroutineScope coroutineScope, CoroutineStart coroutineStart) {
        ...
        return BroadcastKt.broadcast$default(coroutineScope, asChannelFlow.context, i, coroutineStart, null, new FlowKt__ChannelsKt$broadcastIn$1(flow, null), 8, null);
    }
