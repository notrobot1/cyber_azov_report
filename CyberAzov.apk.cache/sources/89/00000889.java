...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    private final FrameLayout iconContainer = (FrameLayout) findViewById(R.id.navigation_bar_item_icon_container);
    private final View activeIndicatorView = findViewById(R.id.navigation_bar_item_active_indicator_view);
    private int itemPaddingTop = getResources().getDimensionPixelSize(getItemDefaultMarginResId());
