...
public interface ReceiveChannel<E> {
    ...
    Object mo1470receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1471tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1471tryReceivePtdJZtk = receiveChannel.mo1471tryReceivePtdJZtk();
            if (ChannelResult.m1487isSuccessimpl(mo1471tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1483getOrThrowimpl(mo1471tryReceivePtdJZtk);
            }
            Throwable m1481exceptionOrNullimpl = ChannelResult.m1481exceptionOrNullimpl(mo1471tryReceivePtdJZtk);
            if (m1481exceptionOrNullimpl != null) {
                throw StackTraceRecoveryKt.recoverStackTrace(m1481exceptionOrNullimpl);
            }
            return null;
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L19:
                ...
                java.lang.Object r4 = r5.m1489unboximpl()
                goto L44
            L30:
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1470receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1482getOrNullimpl(r4)
                return r4
            */
