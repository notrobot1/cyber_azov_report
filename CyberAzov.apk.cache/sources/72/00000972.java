...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean z) {
        ...
        if (cls == null) {
            ...
            str = (!z || !cls.isPrimitive()) ? cls.getName() : JvmClassMappingKt.getJavaObjectType((KClass) getClassifier()).getName();
        }
        String str2 = "";
        ...
        String str3 = str + joinToString$default + str2;
        KType kType = this.platformTypeUpperBound;
        if (kType instanceof TypeReference) {
            String asString = ((TypeReference) kType).asString(true);
            return Intrinsics.areEqual(asString, str3) ? str3 : Intrinsics.areEqual(asString, new StringBuilder().append(str3).append('?').toString()) ? str3 + '!' : '(' + str3 + ".." + asString + ')';
        }
        return str3;
    }
