...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1231getResultxLWZpok() {
        return this.result;
    }
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> m1231getResultxLWZpok = m1231getResultxLWZpok();
                if (m1231getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(m1231getResultxLWZpok.m57unboximpl());
                }
            }
        }
    }
