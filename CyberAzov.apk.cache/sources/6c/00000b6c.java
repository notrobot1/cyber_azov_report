...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo1470receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r5 = r0.m1490closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m1492successJP2dKIU(r5)
        L52:
            return r5
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            java.lang.Object r5 = r5.m1489unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1470receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk */
    public final Object mo1471tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1491failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m1490closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1492successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        Object m1508constructorimpl$default = InlineList.m1508constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.remove()) {
                    ...
                    m1508constructorimpl$default = InlineList.m1513plusFjFbRPM(m1508constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1469onCancelIdempotentListww6eGU(m1508constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            ...
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1477boximpl(z ? companion.m1490closedJP2dKIU(((Closed) obj).closeCause) : companion.m1492successJP2dKIU(obj)), selectInstance.getCompletion());
        } else if (i == 0) {
            ...
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1477boximpl(ChannelResult.Companion.m1490closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m48constructorimpl(ResultKt.createFailure(receiveException)));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1477boximpl(ChannelResult.Companion.m1492successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Throwable receiveException = closed.getReceiveException();
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m48constructorimpl(ResultKt.createFailure(receiveException)));
                return;
            }
            ChannelResult m1477boximpl = ChannelResult.m1477boximpl(ChannelResult.Companion.m1490closedJP2dKIU(closed.closeCause));
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m48constructorimpl(m1477boximpl));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1477boximpl(ChannelResult.Companion.m1492successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            ...
            if (i == 0) {
                ...
                CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1477boximpl(ChannelResult.Companion.m1490closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
            }
        }
    ...
    protected void mo1469onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
