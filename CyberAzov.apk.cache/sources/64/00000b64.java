...
public class Flow extends VirtualLayout {
    ...
    public void measure(int i, int i2, int i3, int i4) {
        ...
        char c6 = z ? 1 : 0;
        char c7 = z ? 1 : 0;
        int i15 = iArr[c] + paddingTop + paddingBottom;
        if (i == 1073741824) {
            i14 = i2;
    ...
    private void measureChainWrap(ConstraintWidget[] constraintWidgetArr, int i, int i2, int i3, int[] iArr) {
        ...
        while (i21 < size) {
            ...
            if (i2 == 0) {
                ...
                i5 = i21;
                widgetsList3.setup(i2, constraintAnchor10, constraintAnchor12, constraintAnchor13, constraintAnchor2, i22, i17, i18, i7, i3);
                ...
                widgetsList3.setup(i2, constraintAnchor15, constraintAnchor7, constraintAnchor, constraintAnchor6, i22, i17, i6, i23, i3);
    ...
    private void measureChainWrap_new(ConstraintWidget[] constraintWidgetArr, int i, int i2, int i3, int[] iArr) {
        ...
        if (i2 == 0) {
            ...
            while (i12 < i) {
                ...
                int i14 = i4;
                boolean z = (i11 == i3 || (this.mHorizontalGap + i11) + widgetWidth > i3) && widgetsList.biggest != null;
                if (!z && i12 > 0 && (i9 = this.mMaxElementsWrap) > 0 && i13 > i9) {
                    z = true;
                }
                if (z) {
                    widgetsList = new WidgetsList(i2, this.mLeft, this.mTop, this.mRight, this.mBottom, i3);
                    ...
                    i11 = i12 > 0 ? i11 + this.mHorizontalGap + widgetWidth : widgetWidth;
                    i10 = 0;
                }
                widgetsList.add(constraintWidget);
                i12++;
            ...
            while (i16 < i) {
                ...
                int i17 = i4;
                boolean z2 = (i15 == i3 || (this.mVerticalGap + i15) + widgetHeight > i3) && widgetsList.biggest != null;
                if (!z2 && i16 > 0 && (i8 = this.mMaxElementsWrap) > 0 && i8 < 0) {
                    z2 = true;
                }
                if (z2) {
                    widgetsList = new WidgetsList(i2, this.mLeft, this.mTop, this.mRight, this.mBottom, i3);
        ...
        while (i23 < size) {
            ...
            if (i2 == 0) {
                ...
                ConstraintAnchor constraintAnchor14 = constraintAnchor5;
                i5 = i23;
                widgetsList3.setup(i2, constraintAnchor10, constraintAnchor12, constraintAnchor13, constraintAnchor2, i24, i19, i20, i7, i3);
                ...
                ConstraintAnchor constraintAnchor16 = widgetsList3.biggest.mRight;
                widgetsList3.setup(i2, constraintAnchor15, constraintAnchor7, constraintAnchor, constraintAnchor6, i24, i19, i6, i25, i3);
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:100:0x0123 -> B:38:0x0063). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:101:0x0125 -> B:38:0x0063). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:97:0x011b -> B:38:0x0063). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:98:0x011d -> B:38:0x0063). Please submit an issue!!! */
    /*
