...
public class ConstraintLayout extends ViewGroup {
        ...
        public final void measure(ConstraintWidget widget, BasicMeasure.Measure measure) {
            ...
            if (widget.getVisibility() == 8 && !widget.isInPlaceholder()) {
                ...
                if (i12 == 1) {
                    ...
                    i = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i11 + widget.getHorizontalMargin(), -1);
                } else if (i12 != 4) {
                    i = 0;
                } else {
                    i = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i11, -2);
                    ...
                    if (measure.measureStrategy == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z || (z && (view.getMeasuredHeight() == widget.getHeight())) || (view instanceof Placeholder) || widget.isResolvedHorizontally()) {
                            i = View.MeasureSpec.makeMeasureSpec(widget.getWidth(), BasicMeasure.EXACTLY);
                        }
                    }
                }
                ...
                if (i13 == 1) {
                    ...
                    i2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i10 + widget.getVerticalMargin(), -1);
                } else if (i13 != 4) {
                    i2 = 0;
                } else {
                    i2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i10, -2);
                    ...
                    if (measure.measureStrategy == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z2 || (z2 && (view.getMeasuredWidth() == widget.getWidth())) || (view instanceof Placeholder) || widget.isResolvedVertically()) {
                            i2 = View.MeasureSpec.makeMeasureSpec(widget.getHeight(), BasicMeasure.EXACTLY);
                        }
                    }
                }
                ...
                if (constraintWidgetContainer != null && Optimizer.enabled(ConstraintLayout.this.mOptimizationLevel, 256) && view.getMeasuredWidth() == widget.getWidth() && view.getMeasuredWidth() < constraintWidgetContainer.getWidth() && view.getMeasuredHeight() == widget.getHeight() && view.getMeasuredHeight() < constraintWidgetContainer.getHeight() && view.getBaseline() == widget.getBaselineDistance() && !widget.isMeasureRequested()) {
                    if (isSimilarSpec(widget.getLastHorizontalMeasureSpec(), i, widget.getWidth()) && isSimilarSpec(widget.getLastVerticalMeasureSpec(), i2, widget.getHeight())) {
                ...
                if (measure.measureStrategy == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z3 || widget.mMatchConstraintDefaultWidth != 0 || !z4 || widget.mMatchConstraintDefaultHeight != 0) {
                    if ((view instanceof VirtualLayout) && (widget instanceof androidx.constraintlayout.core.widgets.VirtualLayout)) {
                        ((VirtualLayout) view).onMeasure((androidx.constraintlayout.core.widgets.VirtualLayout) widget, i, i2);
                    } else {
                        view.measure(i, i2);
                    }
                    widget.setLastMeasureSpec(i, i2);
                    int measuredWidth = view.getMeasuredWidth();
                    int measuredHeight = view.getMeasuredHeight();
                    i5 = view.getBaseline();
                    i4 = widget.mMatchConstraintMinWidth > 0 ? Math.max(widget.mMatchConstraintMinWidth, measuredWidth) : measuredWidth;
                    if (widget.mMatchConstraintMaxWidth > 0) {
                        i4 = Math.min(widget.mMatchConstraintMaxWidth, i4);
                    }
                    if (widget.mMatchConstraintMinHeight > 0) {
                        i3 = Math.max(widget.mMatchConstraintMinHeight, measuredHeight);
                        i7 = i2;
                    } else {
                        i7 = i2;
                        i3 = measuredHeight;
                    ...
                    if (widget.mMatchConstraintMaxHeight > 0) {
                        i3 = Math.min(widget.mMatchConstraintMaxHeight, i3);
                    }
                    if (!Optimizer.enabled(ConstraintLayout.this.mOptimizationLevel, 1)) {
                        if (z7 && z5) {
                            i4 = (int) ((i3 * widget.mDimensionRatio) + 0.5f);
                        } else if (z8 && z6) {
                            i3 = (int) ((i4 / widget.mDimensionRatio) + 0.5f);
                        }
                    }
                    if (measuredWidth != i4 || measuredHeight != i3) {
                        ...
                        widget.setLastMeasureSpec(i, makeMeasureSpec);
                ...
                measure.measuredNeedsSolverPass = (i4 == measure.horizontalDimension && i3 == measure.verticalDimension) ? false : ConstraintLayout.USE_CONSTRAINTS_HELPER;
                if (layoutParams.needsBaseline) {
                    z9 = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                }
                if (z9 && i5 != -1 && widget.getBaselineDistance() != i5) {
    ...
    public void applyConstraintsFromLayoutParams(boolean isInEditMode, View child, ConstraintWidget widget, LayoutParams layoutParams, SparseArray<ConstraintWidget> idToWidget) {
        ...
        if (layoutParams.circleConstraint != -1) {
            ...
            } else if (i7 != -1 && (constraintWidget4 = idToWidget.get(i7)) != null) {
                widget.immediateConnect(ConstraintAnchor.Type.LEFT, constraintWidget4, ConstraintAnchor.Type.RIGHT, layoutParams.leftMargin, i10);
            }
            if (i3 != -1) {
            ...
            } else if (i2 != -1 && (constraintWidget3 = idToWidget.get(i2)) != null) {
                widget.immediateConnect(ConstraintAnchor.Type.RIGHT, constraintWidget3, ConstraintAnchor.Type.RIGHT, layoutParams.rightMargin, i);
            }
            ...
            } else if (layoutParams.topToBottom != -1 && (constraintWidget2 = idToWidget.get(layoutParams.topToBottom)) != null) {
                widget.immediateConnect(ConstraintAnchor.Type.TOP, constraintWidget2, ConstraintAnchor.Type.BOTTOM, layoutParams.topMargin, layoutParams.goneTopMargin);
            }
            ...
            } else if (layoutParams.bottomToBottom != -1 && (constraintWidget = idToWidget.get(layoutParams.bottomToBottom)) != null) {
                widget.immediateConnect(ConstraintAnchor.Type.BOTTOM, constraintWidget, ConstraintAnchor.Type.BOTTOM, layoutParams.bottomMargin, layoutParams.goneBottomMargin);
            }
