...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        this.mMode = 0;
        this.x = (int) (((startTimePoint.x + (f16 * f10)) + (f17 * f11)) - f13);
        this.y = (int) (((startTimePoint.y + (f10 * f18)) + (f11 * f)) - f15);
    ...
    void initPolar(int parentWidth, int parentHeight, KeyPosition c, MotionPaths s, MotionPaths e) {
        ...
        int i = c.mPositionType;
        if (i == 1) {
            float f10 = Float.isNaN(c.mPercentX) ? f3 : c.mPercentX;
            float f11 = e.x;
            float f12 = s.x;
            ...
            float f19 = Float.isNaN(c.mPercentX) ? f3 : c.mPercentX;
            float f20 = e.x;
            float f21 = s.x;
