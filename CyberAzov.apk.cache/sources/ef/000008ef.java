...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1 extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1493invokeWpGqRn0(((ChannelResult) obj).m1489unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1493invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1477boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1489unboximpl = ((ChannelResult) this.L$0).m1489unboximpl();
            Throwable m1481exceptionOrNullimpl = ChannelResult.m1481exceptionOrNullimpl(m1489unboximpl);
            if (m1481exceptionOrNullimpl != null) {
                throw m1481exceptionOrNullimpl;
            }
            Function2<E, Continuation<? super R>, Object> function2 = this.$block;
            Object m1482getOrNullimpl = ChannelResult.m1482getOrNullimpl(m1489unboximpl);
            this.label = 1;
            obj = function2.invoke(m1482getOrNullimpl, this);
