                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m588contentEqualslec5QzE(((ULongArray) t).m288unboximpl(), ((ULongArray) t2).m288unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m584contentEqualsKJPZfPQ(((UIntArray) t).m210unboximpl(), ((UIntArray) t2).m210unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m583contentEqualsFGO6Aew(((UShortArray) t).m392unboximpl(), ((UShortArray) t2).m392unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m586contentEqualskV0jMPg(((UByteArray) t).m132unboximpl(), ((UByteArray) t2).m132unboximpl())) {
                                                        return false;
                                                    }
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    ...
                    if (uByteArray != null) {
                        bArr = uByteArray.m132unboximpl();
                    }
                    sb.append(UArraysKt.m600contentToString2csIQuQ(bArr));
                } else if (t instanceof UShortArray) {
                    UShortArray uShortArray = (UShortArray) t;
                    if (uShortArray != null) {
                        sArr = uShortArray.m392unboximpl();
                    }
                    sb.append(UArraysKt.m604contentToStringd6D3K8(sArr));
                } else if (t instanceof UIntArray) {
                    UIntArray uIntArray = (UIntArray) t;
                    if (uIntArray != null) {
                        iArr = uIntArray.m210unboximpl();
                    }
                    sb.append(UArraysKt.m603contentToStringXUkPCBk(iArr));
                } else if (t instanceof ULongArray) {
                    ULongArray uLongArray = (ULongArray) t;
                    if (uLongArray != null) {
                        jArr = uLongArray.m288unboximpl();
                    }
                    sb.append(UArraysKt.m606contentToStringuLth9ew(jArr));
                } else {
