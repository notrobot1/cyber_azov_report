...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    public String toString() {
        ...
        sb.append(this.schedulerName).append('@').append(DebugStringsKt.getHexAddress(this)).append("[Pool Size {core = ").append(this.corePoolSize).append(", max = ").append(this.maxPoolSize).append("}, Worker States {CPU = ").append(i5).append(", blocking = ").append(i3).append(", parked = ").append(i4).append(", dormant = ").append(i2).append(", terminated = ").append(i).append("}, running workers queues = ").append(arrayList).append(", global CPU queue size = ").append(this.globalCpuQueue.getSize()).append(", global blocking queue size = ").append(this.globalBlockingQueue.getSize());
