...
public final class FragmentStrictMode {
    ...
    public static /* synthetic */ void m34$r8$lambda$3GEKar9k4mm28McDHOXTHzF5lU(Policy policy, Violation violation) {
        m35handlePolicyViolation$lambda0(policy, violation);
    }

    public static /* synthetic */ void $r8$lambda$ujbeN2H_kHMJp2XfgBvtZfltiz0(String str, Violation violation) {
        m36handlePolicyViolation$lambda1(str, violation);
    }
        ...
        if (policy.getListener$fragment_release() != null) {
            runOnHostThread(fragment, new Runnable() { // from class: androidx.fragment.app.strictmode.FragmentStrictMode$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    FragmentStrictMode.m34$r8$lambda$3GEKar9k4mm28McDHOXTHzF5lU(FragmentStrictMode.Policy.this, violation);
                }
            });
        }
    ...
    public static final void m35handlePolicyViolation$lambda0(Policy policy, Violation violation) {
    ...
    public static final void m36handlePolicyViolation$lambda1(String str, Violation violation) {
        Intrinsics.checkNotNullParameter(violation, "$violation");
