...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static boolean m381equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).m392unboximpl());
    }
    ...
    public static final class Iterator extends UShortIterator {
        ...
        public short mo393nextUShortMh2AYeg() {
            int i = this.index;
    ...
    public static boolean m380containsAllimpl(short[] sArr, Collection<UShort> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<UShort> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if (!(obj instanceof UShort) || !ArraysKt.contains(sArr, ((UShort) obj).m375unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
