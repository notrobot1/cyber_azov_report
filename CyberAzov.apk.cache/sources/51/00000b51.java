...
public final class TextStreamsKt {
    ...
    public static final <T> T useLines(Reader reader, Function1<? super Sequence<String>, ? extends T> block) {
        ...
        th = null;
        try {
            return block.invoke(lineSequence(reader instanceof BufferedReader ? (BufferedReader) reader : new BufferedReader(reader, 8192)));
        } finally {
        }
    }
    ...
    public static final void forEachLine(Reader reader, Function1<? super String, Unit> action) {
        ...
        th = null;
        try {
            for (String str : lineSequence(reader instanceof BufferedReader ? (BufferedReader) reader : new BufferedReader(reader, 8192))) {
                action.invoke(str);
            }
