...
public final class ThreadPoolDispatcherKt {
    ...
    public static /* synthetic */ Thread m1464$r8$lambda$IYX93i18CF3E6e1K_suGGxRFcI(int i, String str, AtomicInteger atomicInteger, Runnable runnable) {
        return m1465newFixedThreadPoolContext$lambda1(i, str, atomicInteger, runnable);
    }
    ...
    public static final ExecutorCoroutineDispatcher newFixedThreadPoolContext(final int i, final String str) {
        ...
        return ExecutorsKt.from((ExecutorService) Executors.newScheduledThreadPool(i, new ThreadFactory() { // from class: kotlinx.coroutines.ThreadPoolDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final Thread newThread(Runnable runnable) {
                return ThreadPoolDispatcherKt.m1464$r8$lambda$IYX93i18CF3E6e1K_suGGxRFcI(i, str, atomicInteger, runnable);
            }
        }));
    }

    /* renamed from: newFixedThreadPoolContext$lambda-1 */
    public static final Thread m1465newFixedThreadPoolContext$lambda1(int i, String str, AtomicInteger atomicInteger, Runnable runnable) {
        if (i != 1) {
