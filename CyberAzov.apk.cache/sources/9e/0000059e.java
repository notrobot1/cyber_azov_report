...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m48constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
    ...
    public static final void m1494installSignalHandler$lambda1(Signal signal) {
